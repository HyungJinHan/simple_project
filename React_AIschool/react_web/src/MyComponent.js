...
const Sigong1 = () => {
    const [pic, setPic] = useState(
        <img className='App-logo' src={sigongjoa} alt='sigong' />);

    const changePic1 = () => setPic([
        { id: 1, value: <img className='App-logo' src={sigongjoa} alt='logo' /> },
        { id: 2, value: <img className='App-logo' src={react} alt='logo' /> },
        { id: 3, value: <img className='App-logo' src={taeguk} alt='logo' /> },
    ]);
